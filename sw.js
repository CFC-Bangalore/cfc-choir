// CFC Choir Song Picker — Service Worker v44
const CACHE = 'cfc-choir-v44';
const SHELL = ['./index.html','./chords-data.json','./manifest.json','./manifest-1.json','https://cdnjs.cloudflare.com/ajax/libs/react/18.2.0/umd/react.production.min.js','https://cdnjs.cloudflare.com/ajax/libs/react-dom/18.2.0/umd/react-dom.production.min.js'];
